...
def main():
    ...
    setter_parser = subparsers.add_parser('set_message', help="Interact with a deployed contract")
    ...
    getter_parser = subparsers.add_parser('get_message', help="Interact with a deployed contract")
